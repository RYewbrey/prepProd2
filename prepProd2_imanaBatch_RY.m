...
%%%%%%%%%%%%%% PCM ANALYSIS %%%%%%%%%%%%%%
for i=subj;
    disp(['PCM Analysis: ' subjName{i}])
    %         prepProd2_imana_RY('PCM_sub_make_nii',i)
    %     prepProd2_imana_RY('pcm_sub_make_structs',i)
%         prepProd2_imana_RY('pcm_sub_reslice',i)
%         prepProd2_imana_RY('pcm_sub_make_mask',i)
%         prepProd2_imana_RY('pcm_sub_makeROIs',i)
...
%         prepProd2_imana_RY('pcm_cb_makeROIs',i)
        prepProd2_imana_RY('pcm_cb_preWhiten',i) %slow!
        
%         prepProd2_imana_RY('pcm_cortical_makeROIs',i)
end
