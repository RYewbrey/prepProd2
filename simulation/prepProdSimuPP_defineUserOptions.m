function userOptions = prepProdSimuPP_defineUserOptions(baseDir)
%
...
userOptions.projectName  = 'prepProdSimuPP';
...
userOptions.rootPath = fullfile(baseDir, '\imaging\simulations');
...
[userOptions.conditionLabels{1:userOptions.nConditions}] = deal('O1T1p', 'O1T2p', 'O2T1p', 'O2T2p', 'O1T1P', 'O1T2P', 'O2T1P', 'O2T2P');
