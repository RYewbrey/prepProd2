function userOptions = prepProdSimu_defineUserOptions()
%
...
userOptions.projectName  = 'prepProdSimu';
...
userOptions.rootPath = 'G:\projectsBackup\rhys\prepProd2\data\imaging\simulations';
...
userOptions.nConditions = 4;
% Text lables which may be attached to the conditions for MDS plots.
[userOptions.conditionLabels{1:userOptions.nConditions}] = deal('O1T1', 'O1T2', 'O2T1', 'O2T2');
