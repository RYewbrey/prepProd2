 function prepProdSimu_runsimu(vtemp,vord,vinter,vnoise,n)
%==============================================================================
...
for i=1:n %for iterations
    ...
    [acc_ovrall,acc_int, acc_ord, acc_temp]=prepProdSimu_classify(Y);
    
    D.acc(i,1) = acc_ovrall; D.var(i,1)=1;
    D.acc(i+n,1) = acc_int; D.var(i+n,1)=2;
    D.acc(i+n*2,1)= acc_ord; D.var(i+n*2,1)=3;
    D.acc(i+n*3,1)= acc_temp; D.var(i+n*3,1)=4;
